...
public class HttpClientDownloaderTest {
    ...
    public void test_selectRequestMethod() throws Exception {
        ...
        server.get(eq(query("q"), "us/codecraft/webmagic")).response("get");
        server.post(eq(form("q"), "us/codecraft/webmagic")).response("post");
        server.put(eq(form("q"), "us/codecraft/webmagic")).response("put");
        server.delete(eq(query("q"), "us/codecraft/webmagic")).response("delete");
        server.request(and(by(method("HEAD")),eq(query("q"), "us/codecraft/webmagic"))).response(header("method","head"));
        server.request(and(by(method("TRACE")),eq(query("q"), "us/codecraft/webmagic"))).response("trace");
        ...
        Runner.running(server, new Runnable() {
            ...
            public void run() throws Exception {
                ...
                params.put("q", "us/codecraft/webmagic");
